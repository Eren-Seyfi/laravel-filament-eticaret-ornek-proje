<!-- resources/views/components/adverts/⚡right.blade.php -->
<?php
...
new class extends Component {
    ...
    {
        $this->uid = 'rightSwiper_' . uniqid();
        $this->slides = Advert::slidesForPlacement(AdvertPlacement::Right);
    }
};
?>

<style>
    .right-slider { height: 100%; }
    .right-slider .swiper { width: 100%; height: 100%; }
    .right-slider .swiper-slide { height: 100%; }

    .right-slider .ad-carousel-frame { width: 100%; height: 100%; }
    .right-slider .ad-carousel-img {
        width: 100%;
        height: 100%;
        object-fit: cover;
        display: block;
    ...
    .right-slider .swiper-button-prev { display: none !important; }
</style>

@php $slideCount = is_array($slides) ? count($slides) : 0; @endphp

<div class="right-slider h-100" wire:ignore.self
     data-swiper-fade="1"
     data-swiper-uid="{{ $uid }}"
